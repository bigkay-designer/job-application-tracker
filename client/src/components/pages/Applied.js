...
function Applied({applied, user, deleteJob, deleted}) {
    ...
    return (
        <div className="homeComponent">
            <div className="home__container">
                <div className={`jobs`}>
                    <div className="applied__h1 title__div">
                        <h1>Applied jobs</h1>
                    </div>
                    {/* ************************* */}
                    {applied.map(job =>{
                            return job.section === "applied" && job.author.id === user.id ?
